...
use uni\Bundle\SeriesBundle\Entity\categorias;
use uni\Bundle\SeriesBundle\Form\categoriasType;
...
class categoriasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniSeriesBundle:categorias')->findAll();

        return $this->render('uniSeriesBundle:categorias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniSeriesBundle:categorias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniSeriesBundle:categorias')->find($id);
        ...
        return $this->render('uniSeriesBundle:categorias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniSeriesBundle:categorias:edit.html.twig', array(
            'entity'      => $entity,
