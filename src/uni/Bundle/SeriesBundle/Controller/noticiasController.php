...
use uni\Bundle\SeriesBundle\Entity\noticias;
use uni\Bundle\SeriesBundle\Form\noticiasType;
...
class noticiasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniSeriesBundle:noticias')->findAll();

        return $this->render('uniSeriesBundle:noticias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniSeriesBundle:noticias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniSeriesBundle:noticias')->find($id);
        ...
        return $this->render('uniSeriesBundle:noticias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniSeriesBundle:noticias:edit.html.twig', array(
            'entity'      => $entity,
